...
export default function Header() {
    ...
    return (
        <header className="bg-[var(--main-color)] shadow-lg h-[10vh] relative">
            <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-10 xl:mx-16 h-[100%] flex justify-between">
                ...
                <nav className="h-[100%] flex flex-row justify-around items-center">
                    ...
                    <ul className="hidden md:flex">
                        ...
                        <li>
                            <Link href="contacts" className="font-semibold p-3 rounded hover:bg-[var(--secondary-color)] hover:text-[var(--highlight-color)]">Kontak Kami</Link>
                        </li>
                    </ul>
                    {isOpen && (
                        <ul className="absolute top-full left-0 bg-white shadow-lg rounded mt-2 w-full z-50 md:hidden">
                            ...
                            <li>
                                <Link href="contacts" className="block font-semibold p-3 hover:bg-[var(--secondary-color)] hover:text-[var(--highlight-color)]">Kontak Kami</Link>
                            </li>
                        </ul>
                    )}
                </nav>
