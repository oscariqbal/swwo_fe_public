      ...
      <div className="bg-[var(--neutral-color)] h-[20vh] md:h-[30vh] flex flex-col items-center justify-center">
        <div className="h-[100%] w-[90%] md:w-[80%] flex flex-col items-center justify-center">
          ...
          <p className="md:mt-3 text-center font-normal text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
            Hubungi kami untuk mewujudkan pernikahan impian anda. 
          </p>
        </div>
      </div>
      {/* BAGIAN 2 */}
      <div className="bg-[var(--neutral-color)] h-[70vh] md:h-[60vh] flex flex-col md:flex-row items-center justify-center">
        {/* --v-- BAGIAN BAWAH A --v-- */}
        <div className="w-[100%] h-[50%] md:w-[50%] md:h-[100%] flex items-center justify-center">
          <div className="w-[75%] h-[75%] md:w-[60%] md:h-[60%]">
            {/* --v-- CARD --v-- */}
            <a href={WhatsApp()} target="_blank" rel="noopener noreferrer" className="shadow-xl backdrop-blur-md isolation-auto w-[100%] h-[100%] bg-transparent rounded border-4 border-[var(--highlight-color)] text-[var(--text-color)] p-4 flex flex-col items-start justify-center gap-3 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded before:bg-[var(--highlight-color)] hover:text-[var(--neutral-color)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 overflow-hidden">
        ...
        <div className="w-[100%] h-[50%] md:w-[50%] md:h-[100%] flex items-center justify-center">
          <div className="w-[75%] h-[75%] md:w-[60%] md:h-[60%]">
          {/* --v-- CARD --v-- */}
            <a href={GoogleMaps()} target="_blank" rel="noopener noreferrer" className="shadow-xl backdrop-blur-md isolation-auto w-[100%] h-[100%] bg-transparent rounded border-4 border-[var(--highlight-color)] text-[var(--text-color)] p-4 flex flex-col items-start justify-center gap-3 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded before:bg-[var(--highlight-color)] hover:text-[var(--neutral-color)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 overflow-hidden">
