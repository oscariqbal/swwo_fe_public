...
export default function Home() {
  return (
    <main>
      {/* BAGIAN 1 */}
      <div className="h-[90vh] flex flex-col items-center justify-center bg-[url('/img/Home/bg.jpg')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="bg-[var(--neutral-color)] h-[100vh] flex flex-col items-center justify-center">
        ...
        <div className="border border-white w-[100%] h-[90%] md:h-[80%] flex flex-col items-center justify-between bg-[url('/img/Home/bg2fix.jpg')] bg-cover bg-center bg-no-repeat">
